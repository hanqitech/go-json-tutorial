...
`
	...
	expect := testObject{
		Image: Image{
			...
			Animated: false,
			IDs:      []int{116, 943, 234, 38793},
		},
	}

	var objectResult testObject
	...
	var arrayResult []testArrayObject
